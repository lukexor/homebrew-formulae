cask "tetanes" do
  ...
  if Hardware::CPU.intel?
    url "https://github.com/lukexor/tetanes/releases/download/tetanes-v0.10.0/tetanes-0.10.0-x86_64-apple.tar.gz"
    sha256 "0f2920c1ee125872357d69f3cb4400796f2014a3dbb379c9d54b5f49cfc6ce8f"
  else
    url "https://github.com/lukexor/tetanes/releases/download/tetanes-v0.10.0/tetanes-0.10.0-aarch64-apple.tar.gz"
